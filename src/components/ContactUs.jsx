...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        try {
            const response = await fetch("https://docs.google.com/forms/u/0/d/e/FORM_ID/formResponse", {
            method: "POST",
            body: formData,
            mode: "no-cors"
     });
  ...
  desc='Contact us to join our quantum community, collaborate, and get your questions answered.' 
/>
